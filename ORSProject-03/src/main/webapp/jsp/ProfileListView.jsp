<%@page import="in.co.rays.proj3.controller.ProfileListCtl"%>
<%@page import="in.co.rays.proj3.utill.HTMLUtility"%>
<%@page import="in.co.rays.proj3.utill.DataUtility"%>
<%@page import="in.co.rays.proj3.dto.ProfileDTO"%>
...
<body class="p4">
	...
	<div class="container-fluid">
		...
		<jsp:useBean id="dto" class="in.co.rays.proj3.dto.ProfileDTO"
