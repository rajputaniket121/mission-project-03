<%@page import="in.co.rays.proj3.controller.SupportListCtl"%>
<%@page import="in.co.rays.proj3.utill.HTMLUtility"%>
<%@page import="in.co.rays.proj3.utill.DataUtility"%>
<%@page import="in.co.rays.proj3.dto.SupportDTO"%>
...
<body class="p4">
    ...
    %>
        ...
        <form action="<%=ORSView.SUPPORT_LIST_CTL%>" method="post">
            ...
            List<SupportDTO> list =
                (List<SupportDTO>) ServletUtility.getList(request);

            Iterator<SupportDTO> it = list.iterator();
                    ...
                    <tr>
                        <td>
                            <div
                                ...
                                <div class="mx-2">
                                    <input type="text" class="form-control form-control-sm"
                                        name="issueType" placeholder="Enter Issue Type"
                                ...
                                <div class="mx-2">
                                    <%=HTMLUtility.getList("ticketStatus", String.valueOf(dto.getTicketStatus()), ticketStatusMap)%>
                                </div>
                                <div class="mx-2">
                                    <input type="submit" class="btn btn-sm btn-primary"
                                        name="operation" value="<%=SupportListCtl.OP_SEARCH%>">
                                    <input type="submit"
            ...
            <div class="table-responsive">
                ...
                %>
                        <tr>
                            ...
                            <td><%=dto.getIssueDescription()%></td>
                            <td><%=dto.getTicketStatus()%></td>
                            <td><a href="SupportCtl?id=<%=dto.getId()%>"
            ...
            <table class="table w-100">
                <tr>
                    <td width="25%"><input type="submit"
                        ...
                        value="<%=SupportListCtl.OP_PREVIOUS%>"
