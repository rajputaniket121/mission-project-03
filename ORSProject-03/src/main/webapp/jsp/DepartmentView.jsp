<%@page import="in.co.rays.proj3.controller.DepartmentCtl"%>
            ...
            <div class="container">
                <div class="row justify-content-center mt-4">
                    ...
                    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                        ...
                        <form action="<%=ORSView.DEPARTMENT_CTL%>" method="post" class="w-100">

                            <jsp:useBean id="dto" class="in.co.rays.proj3.dto.DepartmentDTO"
                            ...
                            <div class="card grad-card shadow-sm">
                                ...
                                %>
                                    ...
                                    HashMap<String, String> locationMap =
                                        (HashMap<String, String>) request.getAttribute("locationMap");
                                %>
                                    ...
                                    <div class="form-group mb-3">
                                        <label><strong>Department Code</strong> <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="departmentCode" class="form-control"
                                                ...
                                                value="<%=DataUtility.getStringData(dto.getDepartmentCode())%>">
                                        </div>
                                        <small class="text-danger"> <%=ServletUtility.getErrorMessage("departmentCode", request)%>
                                        </small>
                                    </div>

                                    <!-- Department Name -->
                                    <div class="form-group mb-3">
                                        <label><strong>Department Name</strong> <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i
                                                    class="fa fa-building text-muted"></i></span>
                                            </div>
                                            <input type="text" name="departmentName" class="form-control"
                                                placeholder="Enter Department Name"
                                                value="<%=DataUtility.getStringData(dto.getDepartmentName())%>">
                                        </div>
                                        <small class="text-danger"> <%=ServletUtility.getErrorMessage("departmentName", request)%>
                                        </small>
                                    </div>

                                    <!-- Department Head -->
                                    <div class="form-group mb-3">
                                        <label><strong>Department Head</strong> <span class="text-danger">*</span></label>
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i
                                        ...
                                        <small class="text-danger"> <%=ServletUtility.getErrorMessage("departmentHead", request)%>
                                        </small>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i
                                                    class="fa fa-map-marker text-muted"></i></span>
                                            </div>
                                            <%=HTMLUtility.getList("location", dto.getLocation(), locationMap)%>
                                        </div>
                                        <small class="text-danger"> <%=ServletUtility.getErrorMessage("location", request)%>
                                        </small>
                                    </div>
