...
<script>
	$(function() {
		...
		$('.dropdown-menu > a[data-toggle="dropdown"]').on('click',
				function(e) {
					e.preventDefault();
					e.stopPropagation();
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		...
		<a class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>"> <img
			src="<%=ORSView.APP_CONTEXT%>/img/custom.png" height="42">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown px-1"><a
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.MY_PROFILE_CTL%>"> <i
							class="fa fa-user mr-2"></i>My Profile
				...
				<!-- All original admin top menus restored exactly -->
				...
				<!-- Keep ALL other admin menus exactly same as your old file -->

				<!-- ================= USE CASES (UNCHANGED UI) ================= -->
				<li class="nav-item dropdown px-1"><a
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item border-bottom" href="#"
							data-toggle="dropdown"> <i class="fa fa-user mr-2"></i>Profile
						</a>
						<div class="dropdown-submenu px-3 py-2">
							<a class="dropdown-item" href="<%=ORSView.PROFILE_CTL%>"> <i
								class="fa fa-plus mr-2"></i>Add Profile
							</a> <a class="dropdown-item" href="<%=ORSView.PROFILE_LIST_CTL%>">
								<i class="fa fa-list mr-2"></i>Profile List
							</a>
						</div>

						<a class="dropdown-item border-bottom" href="#"
							data-toggle="dropdown"> <i class="fa fa-address-book mr-2"></i>Contact
						</a>
						<div class="dropdown-submenu px-3 py-2">
							<a class="dropdown-item" href="<%=ORSView.CONTACT_CTL%>"> <i
								class="fa fa-plus mr-2"></i>Add Contact
							</a> <a class="dropdown-item" href="<%=ORSView.CONTACT_LIST_CTL%>">
								<i class="fa fa-list mr-2"></i>Contact List
							</a>
						</div>

						<a class="dropdown-item border-bottom" href="#"
							data-toggle="dropdown"> <i class="fa fa-life-ring mr-2"></i>Support
						</a>
						<div class="dropdown-submenu px-3 py-2">
							<a class="dropdown-item" href="<%=ORSView.SUPPORT_CTL%>"> <i
								class="fa fa-ticket-alt mr-2"></i>Add Ticket
							</a> <a class="dropdown-item" href="<%=ORSView.SUPPORT_LIST_CTL%>">
								<i class="fa fa-list mr-2"></i>Ticket List
							</a>
						</div>

						<a class="dropdown-item border-bottom" href="#"
							data-toggle="dropdown"> <i class="fa fa-bell mr-2"></i>Alert
						</a>
						<div class="dropdown-submenu px-3 py-2">
							<a class="dropdown-item" href="<%=ORSView.ALERT_CTL%>"> <i
								class="fa fa-plus-circle mr-2"></i>Add Alert
							</a> <a class="dropdown-item" href="<%=ORSView.ALERT_LIST_CTL%>">
								<i class="fa fa-list mr-2"></i>Alert List
							</a>
						</div>

						<a class="dropdown-item border-bottom" href="#"
							data-toggle="dropdown"> <i class="fa fa-comment mr-2"></i>Feedback
						</a>
						<div class="dropdown-submenu px-3 py-2">
							<a class="dropdown-item" href="<%=ORSView.FEEDBACK_CTL%>"> <i
								class="fa fa-plus mr-2"></i>Add Feedback
							</a> <a class="dropdown-item" href="<%=ORSView.FEEDBACK_LIST_CTL%>">
								<i class="fa fa-list mr-2"></i>Feedback List
							</a>
						</div>

						<a class="dropdown-item" href="#" data-toggle="dropdown"> <i
							class="fa fa-clock mr-2"></i>Shift
						</a>
						<div class="dropdown-submenu px-3 py-2">
							<a class="dropdown-item" href="<%=ORSView.SHIFT_CTL%>"> <i
								class="fa fa-plus mr-2"></i>Add Shift
							</a> <a class="dropdown-item" href="<%=ORSView.SHIFT_LIST_CTL%>">
								<i class="fa fa-list mr-2"></i>Shift List
							</a>
						</div>
				...
				<!-- ================= PROFILE / AUTH (Java Doc RESTORED) ================= -->
				<li class="nav-item dropdown px-1"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
						<%=welcomeMsg%>
				</a>
