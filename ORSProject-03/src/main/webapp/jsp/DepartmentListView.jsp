<%@page import="in.co.rays.proj3.controller.DepartmentListCtl"%>
<%@page import="in.co.rays.proj3.utill.HTMLUtility"%>
<%@page import="in.co.rays.proj3.utill.DataUtility"%>
<%@page import="in.co.rays.proj3.dto.DepartmentDTO"%>
    ...
    %>
        ...
        <form action="<%=ORSView.DEPARTMENT_LIST_CTL%>" method="post">
            ...
            List<DepartmentDTO> list =
                (List<DepartmentDTO>) ServletUtility.getList(request);
                            ...
                            <div
                                ...
                                <div class="mx-2">
                                    <input type="text" class="form-control form-control-sm"
                                        name="departmentCode" placeholder="Enter Department Code"
                                        value="<%=ServletUtility.getParameter("departmentCode", request)%>">
                                </div>
                                <div class="mx-2">
                                ...
                                <div class="mx-2">
                                    <%=HTMLUtility.getList("location", String.valueOf(dto.getLocation()), locationMap)%>
                                </div>
                                <div class="mx-2">
                                    <input type="submit" class="btn btn-sm btn-primary"
                                        name="operation" value="<%=DepartmentListCtl.OP_SEARCH%>">
                                    <input type="submit"
            ...
            <div class="table-responsive">
                ...
                %>
                        <tr>
                            ...
                            <td><%=dto.getDepartmentHead()%></td>
                            <td><%=dto.getLocation()%></td>
                            <td><a href="DepartmentCtl?id=<%=dto.getId()%>"
